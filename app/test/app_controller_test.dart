...
Future<Setup> setup({List<Laptop> saved = const [laptopA, laptopB], bool withCredentials = true}) async {
  ...
  final app = AppController(
    ...
    settings: settings,
    cache: cache,
    apiFor: (host, port, pin) => (host.startsWith('192.168.2.') ? netB : netA).apiFor(host, port, pin),
    discovery: discovery,
  );
  await app.init();
