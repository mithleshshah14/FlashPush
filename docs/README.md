...
| [quickstart.md](quickstart.md) | first end-to-end test: start the laptop, install the app, pair, send | written |
| [repo-security.md](repo-security.md) | the repository is public: what that means, secret scanning, GitHub settings, audit result | written |
