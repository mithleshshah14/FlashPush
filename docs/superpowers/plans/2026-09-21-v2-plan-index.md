...
| 1B-ii-b | **Admin API and wiring** | loopback admin API + temporary admin page, `index.js` wiring (HTTPS + admin + UDP + timers), HTTPS end-to-end test, `architecture.md`, `security.md` | §3.5, §2 | 1B-ii-a | to write |
